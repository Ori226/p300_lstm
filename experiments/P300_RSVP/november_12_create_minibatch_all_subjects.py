...
if __name__ == "__main__":
    ...
    model = LDA()
    train_data = np.vstack(train_data_all_subject)
    train_tags = np.vstack(train_tags_all_subject).flatten()

    test_data = np.vstack(test_data_all_subject)
    ...
    print "accuracy_train:{}, auc_score_train:{} ".format(accuracy_train, auc_score_train )
