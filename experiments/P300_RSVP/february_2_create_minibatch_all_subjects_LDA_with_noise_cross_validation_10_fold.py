...
if __name__ == "__main__":
    ...
    for cross_validation_iter in range(10):
        ...
        for time_shift_noise in noist_shifts:
            ...
            print "cv:{} noise:{} accuracy_test {}:{}, auc_score_train:{} ".format(cross_validation_iter,
                                                                                   time_shift_noise, 0, accuracy_test,
                                                                                   auc_score_test)
        ...
        print "cv:{} accuracy_train {}:{}, auc_score_train:{} ".format(cross_validation_iter, 0, accuracy_train,
                                                                       auc_score_train)
