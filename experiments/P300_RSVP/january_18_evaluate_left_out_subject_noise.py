...
def train_on_subjset(all_subjects, model_file_name):
    ...
    for experiment_counter, subject in enumerate(all_subjects[start_idx:end_idx]):
        ...
        for rep_per_sub, cross_validation_indexes in enumerate(
            ...
            only_p300_model_1.set_weights(original_wights) #=   get_only_P300_model_LSTM_CNN(eeg_sample_shape)
    ...
    # print ("temp")
# C:\git\thesis_clean_v3\experiments\P300_RSVP\model_left_out\model_cnn_all_subjects.h5

if __name__ == "__main__":

    all_subjects_code =  ['gcd', 'gcc', 'pia', 'gcb', 'gcf', 'gcg', 'gch', 'iay', 'icn', 'icr', 'fat']
    all_subjects = [(["RSVP_Color116msVP{}.mat".format(code)],
                    r"C:\git\thesis_clean_v3\experiments\P300_RSVP\model_left_out\model_smaller_lstm_cnn_all.h5") for code in all_subjects_code]
    # all_subjects_code.insert(0,'all')
