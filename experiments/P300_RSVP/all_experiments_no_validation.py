...
if __name__ == "__main__":
    ...
    # all_models = [LSTM_EEG_no_valid(1.0, 20), LSTM_EEG_no_valid(50.0, 20), LSTM_EEG_no_valid(50.0, 100), LSTM_EEG_no_valid(1.0, 100), My_LDA()]
    all_models = [LSTM_EEG_no_valid(50.0, 20), LSTM_EEG_no_valid(50.0, 100), My_LDA()]
    for model_type in all_models:
        ...
        # repetition_eval.foo(test_tags, prediction_res)
        #
        # training_data, train_tags, testing_data, test_tags = create_training_and_testing(gcd_res, -200, 800, 8, False)
        # model.fit(training_data, train_tags)
        # prediction_res = model.predict(testing_data)
        # repetition_eval.foo(test_tags, prediction_res)

    # experiment 0-400| 100 hidden| <2 layers>| no downsample | 50-50 samples
    # experiment 0-400| 100 hidden| 2 layers| no downsample | all samples

    # experiment 0-400| 100 hidden| <2 layers>| 8 downsample | 50-50 samples
    # experiment 0-400| 100 hidden| 2 layers| 8 downsample | all samples


    # experiment 0-400| 20 hidden| <2 layers>| no downsample | 50-50 samples
    # experiment 0-400| 20 hidden| 2 layers| no downsample | all samples

    # experiment 0-400| 20 hidden| <2 layers>| 8 downsample | 50-50 samples
    # experiment 0-400| 20 hidden| 2 layers| 8 downsample | all samples


    # experiment -200-800| 100 hidden| <2 layers>| no downsample | 50-50 samples
    # experiment -200-800| 100 hidden| 2 layers| no downsample | all samples

    # experiment -200-800| 100 hidden| <2 layers>| 8 downsample | 50-50 samples
    # experiment -200-800| 100 hidden| 2 layers| 8 downsample | all samples


    # experiment -200-800| 20 hidden| <2 layers>| no downsample | 50-50 samples
    # experiment -200-800| 20 hidden| 2 layers| no downsample | all samples

    # experiment -200-800| 20 hidden| <2 layers>| 8 downsample | 50-50 samples
    # experiment -200-800| 20 hidden| 2 layers| 8 downsample | all samples
