from P300Net.data_preparation import create_data_rep_training, triplet_data_generator, triplet_data_collection, \
    triplet_data_generator_no_dict, get_number_of_samples_per_epoch
...
if __name__ == "__main__":
    ...
    for subject in all_subjects:
        ...
        P300IdentificationModel.fit_generator(data_generator,number_of_samples_in_epoch, nb_epoch=4)
